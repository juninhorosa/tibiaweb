...
const proxy = spawn(process.execPath, ["server.js"], {
  ...
  env: { ...process.env, PORT: "9998", TARGET_HOST: "127.0.0.1", TARGET_PORT: "9999", CERT_PATH: "certs/cert.pem", KEY_PATH: "certs/key.pem" },
...
const ws = new WebSocket("wss://127.0.0.1:9998", { rejectUnauthorized: false });
